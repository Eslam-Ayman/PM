        ...
        <section class="content">
             ...
             <!-- general form elements -->
              <div class="box box-primary">
                ...
                <!-- form start -->
                <form role="form" action="/projects/{{$project->id}}" method="POST"  enctype="multipart/form-data">
                  <div class="box-body">
                 @csrf
                 <input name="_method" type="hidden" value="PUT">
                    <div class="form-group">
                      <label for="exampleInputEmail1">العنوان</label>
                      <input type="text" class="form-control" placeholder="" name="title" value="{{$project->title}}">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputPassword1">الوصف</label>
                      <input type="text" class="form-control" placeholder="" name="description" value="{{$project->description}}">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputPassword1">موعد الانتهاء</label>
                      <input type="date" class="form-control" placeholder="" name="due_date" value="{{$project->due_date}}">
                    </div>
                    <div class="form-group">
                ...
                <div class="col-xs-4">
                  <img src="{{$file->file_path}}" class="img-responsive">
                </div>
                @endforeach
                </div>
              </div><!-- /.box -->
